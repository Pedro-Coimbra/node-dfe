    ...
    static getInfoQRCodeByUF(uf, amb) {
        if (amb == '1') {
            switch (uf) {
                ...
                case 'GO':
                    return { urlChave: 'www.sefaz.go.gov.br/nfce/consulta', urlQRCode: 'https://nfeweb.sefaz.go.gov.br/nfeweb/sites/nfce/danfeNFCe' };
                case 'MA':
                    return { urlChave: 'www.sefaz.ma.gov.br/nfce/consulta', urlQRCode: 'http://www.nfce.sefaz.ma.gov.br/portal/consultarNFCe.jsp' };
                case 'MG':
                    return { urlChave: 'https://portalsped.fazenda.mg.gov.br/portalnfce', urlQRCode: 'https://portalsped.fazenda.mg.gov.br/portalnfce/sistema/qrcode.xhtml' };
                case 'MS':
            ...
            switch (uf) {
                ...
                case 'MG':
                    return { urlChave: 'https://hportalsped.fazenda.mg.gov.br/portalnfce', urlQRCode: 'https://portalsped.fazenda.mg.gov.br/portalnfce/sistema/qrcode.xhtml' };
                case 'MS':
                    return { urlChave: 'http://www.dfe.ms.gov.br/nfce/consulta', urlQRCode: 'http://www.dfe.ms.gov.br/nfce/qrcode' };
                case 'MT':
